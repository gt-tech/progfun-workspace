...
object SimpleFixedPointFindingExercise {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(472); 
  ...
  def sqrt_alt(x: Double) = fixedPoint( averageDamp( y => x/y) )(1.0);System.out.println("""sqrt_alt: (x: Double)Double""");$skip(535); 
  ...
  def averageDamp(f: Double => Double)(num: Double) = (num + f(num)) / 2;System.out.println("""averageDamp: (f: Double => Double)(num: Double)Double""");$skip(12); val res$1 = 
